...
import TicketValidationScreen    from '../screens/passenger/TicketValidationScreen';
...
export default function PassengerTabNavigator() {
  return (
    ...
    >
      ...
      <Tab.Screen name="Tracking" component={TrackingStack} options={{ title: 'Live Map' }} />
      <Tab.Screen name="Tickets"  component={TicketsStack}  options={{ title: 'My Tickets' }} />
