...
const STATUS_MAP = {
  BOOKED: {
    label: "Booked",
    bg: COLORS.statusBooked,
    text: COLORS.statusBookedText,
  },
      ...
      <View style={styles.body}>
        <View style={styles.journey}>
          <View style={styles.journeyPoint}>
            ...
            <Text style={styles.journeyStop} numberOfLines={1}>
              {ticket.origin ?? "—"}
            </Text>
          </View>
        ...
        <View style={styles.meta}>
          <MetaItem
            ...
            value={ticket.date ?? ticket.travelDate ?? "—"}
          />
          <MetaItem icon="time-outline" value={ticket.boardingTime ?? "—"} />
          <MetaItem icon="ticket-outline" value={`#${ticket.code ?? "—"}`} />
        </View>
      </View>
    </TouchableOpacity>
  );
